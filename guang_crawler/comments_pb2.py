...
_COMMENTS = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='page', full_name='com.langtaojin.guang.taobao.comments.page', index=9,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='crawltime', full_name='com.langtaojin.guang.taobao.comments.crawltime', index=10,
